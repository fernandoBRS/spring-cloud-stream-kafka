...
public class AvroMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroMessage\",\"namespace\":\"com.example.streaming.avro.messages\",\"fields\":[{\"name\":\"headers\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"payload\",\"type\":\"bytes\"}]}");
   ...
   */
  public static com.example.streaming.avro.messages.AvroMessage.Builder newBuilder() {
    return new com.example.streaming.avro.messages.AvroMessage.Builder();
  }
   ...
   * @return A new AvroMessage RecordBuilder
   */
  public static com.example.streaming.avro.messages.AvroMessage.Builder newBuilder(com.example.streaming.avro.messages.AvroMessage.Builder other) {
    return new com.example.streaming.avro.messages.AvroMessage.Builder(other);
  }
   ...
   * @return A new AvroMessage RecordBuilder
   */
  public static com.example.streaming.avro.messages.AvroMessage.Builder newBuilder(com.example.streaming.avro.messages.AvroMessage other) {
    return new com.example.streaming.avro.messages.AvroMessage.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.streaming.avro.messages.AvroMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.streaming.avro.messages.AvroMessage other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.headers)) {
        this.headers = data().deepCopy(fields()[0].schema(), other.headers);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.streaming.avro.messages.AvroMessage.Builder setHeaders(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.streaming.avro.messages.AvroMessage.Builder clearHeaders() {
      headers = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.streaming.avro.messages.AvroMessage.Builder setPayload(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.streaming.avro.messages.AvroMessage.Builder clearPayload() {
      payload = null;
